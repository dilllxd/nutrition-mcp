...
app.use("*", async (c, next) => {
    ...
    if (!c.res.headers.get("Content-Security-Policy")) {
        c.header(
            ...
            "default-src 'self'; script-src 'self'; connect-src 'self'; style-src 'self' https://cdn.jsdelivr.net https://fonts.googleapis.com; font-src https://fonts.gstatic.com; img-src 'self'; frame-ancestors 'none'",
        );
    }
